 ...
 * @author VIENTHONGA
 */
public class fViewKhachHang extends javax.swing.JFrame {
    ...
    public String maNV;
    public String id;
    public fViewKhachHang() {
        initComponents();
        setIcon();
    }
    public fViewKhachHang(String maNV, String id) {
        this.maNV=maNV;
        this.id=id;
        initComponents();
        setIcon();
    ...
    {
        NhanVien nv = model.DAO.daoTaiKhoan.getInstance().getNhanVien(id);
        jLabelTenNhanVien.setText(nv.getTenNV());
        jLabelSdt.setText(nv.getSDT());
        jLabelCmnd.setText(nv.getMaNV());
        jLabelNgaySinh.setText(nv.getNgaySinh().toString());
...
//        jLabelHinhAnh.setIcon(imageIcon);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Xem thông tin khách hàng");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel6)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanelNhanVien, javax.swing.GroupLayout.DEFAULT_SIZE, 275, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fViewKhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fViewKhachHang("1","1").setVisible(true);
            }
        });
    }
