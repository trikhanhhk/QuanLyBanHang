 ...
 * @author HoaTran
 */
public class fChiPhieuNhap extends javax.swing.JFrame {
    ...
    public String maNV;
    public String idPn;
    public ArrayList<ChiTietPhieuNhap> DanhSachChiTietHD;
    public long count, SoTrang, Trang = 1;
    public ArrayList<ChiTietPhieuNhap> DuLieuMau;

    public fChiPhieuNhap() {
        initComponents();
        setIcon();
        build();
    }

    public fChiPhieuNhap(String idnv, String idPn) {
        this.maNV = idnv;
        this.idPn = idPn;
        initComponents();
        setIcon();
        DanhSachChiTietHD = daoChiTietPhieuNhap.getInstance().getAllChiTiet(idPn);
    ...
    private void setData(){
        PhieuNhap pn = daoPhieuNhap.getInstance().getPhieuNhapByID(idPn);
        String maNcc = pn.getMaNCC();
        txtMaKH.setText(maNcc);
        NhaCungCap kh = daoNhaCungCap.getInstance().getNhaCungCap(maNcc);
        txtTenKH.setText(kh.getTenNCC());
    }
    ...
    private void initComponents() {
        ...
        ArrayList<ChiTietPhieuNhap> DuLieuMau = model.DAO.daoChiTietPhieuNhap.getInstance().getAllChiTiet(idPn);
        ...
        for(int i = 0; i < DuLieuMau.size(); i++){
            SanPham sp = daoSanPham.getInstance().getSanPham(DuLieuMau.get(i).getMaSP());
            rows[i][0] = i+1;
            rows[i][1] = DuLieuMau.get(i).getMaSP();
        ...
        jTableChiTietHD.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã nhà cung cấp", "Tên nhà cung cấp", "Địa chỉ", "Số điện thoại", "Trạng thái"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrame kh = new fChiPhieuNhap("NV12", "");
                kh.setVisible(true);
            }
        });
    }
    ...
    public void build() {
        DanhSachChiTietHD = DuLieuMau;
        System.out.println("Kh: " + idPn);
        ArrayList<ChiTietPhieuNhap> table = model.DAO.daoChiTietPhieuNhap.getInstance().getAllChiTiet(idPn);
        listDanhSachChiTietPhieuNhap(table);
    }
    ...
    public void listDanhSachChiTietPhieuNhap(ArrayList<ChiTietPhieuNhap> arr) {
