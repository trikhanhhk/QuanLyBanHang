...
public class fChiTietHoaDon extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ArrayList<ChiTietHoaDon> DuLieuMau = model.DAO.daoQuanLyChiTietHoaDon.getInstance().getAllChiTiet(idHD);
    ...
    public void build() {
        ...
        ArrayList<ChiTietHoaDon> table = model.DAO.daoQuanLyChiTietHoaDon.getInstance().getAllChiTiet(idHD);
