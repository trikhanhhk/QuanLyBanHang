...
//            Xem.setVisible(true); tạo form fViewKhachHang
    ...
    private void jButtonNhoMaxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNhoMaxActionPerformed
        Trang = 1;
        ArrayList<KhachHang> table = model.DAO.daoKhachHang.getInstance().get20KhachHang(DanhSachKhachHang, Trang);
    ...
    private void jButtonSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSuaActionPerformed
        ...
        KhachHang KHSua = model.DAO.daoKhachHang.getInstance().getKhachHangByID(maKH);
    ...
    public void build() {
        ...
        jLabelSoTrang.setText("1/" + SoTrang);
        jLabelTrang.setText("1");
        ArrayList<KhachHang> table = model.DAO.daoKhachHang.getInstance().get20KhachHang(DanhSachKhachHang, 1);
        listDanhSachKhachHang(table);
    }

    public void FindList() {
        this.DanhSachKhachHang = model.DAO.daoKhachHang.getInstance().FindListKhachHang(DuLieuMau, jTextFieldTimKiem.getText());
