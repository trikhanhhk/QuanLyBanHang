...
public class fThongBaoHuy extends javax.swing.JFrame {
    ...
    public fThongBaoHuy(String type,int id, String maNV) {
        this.type=type;
        this.id=id;
        this.maNV=maNV;
        initComponents();
    ...
    private void jButtonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOkActionPerformed
        ...
        {
            this.setVisible(false);
            DAO.daoKhuVuc.getInstance().HuyKhuVuc(id, maNV);
        }
        if("PhieuNhap".equals(type))
        {
            this.setVisible(false);
            DAO.daoKhuVuc.getInstance().HuyPhieuNhap(id, maNV);
        }
        if("XuatKho".equals(type))
        {
            this.setVisible(false);
            DAO.daoXuatKho.getInstance().HuyPhieuXuat(id, maNV);
        }
