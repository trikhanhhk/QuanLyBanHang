...
public class fCreate_PhieuXuat extends javax.swing.JFrame {
    ...
    public fCreate_PhieuXuat(String maNV) {
        this.maNV=maNV;
        initComponents();
        setIcon();
        build();
    }
    public fCreate_PhieuXuat(String maNV, int kohakuu)
    {
        PX = new fCreate_PhieuXuat(maNV);
        setIcon();
        PX.setVisible(true);
        isopen=true;
    }
    ...
    {
        TaiKhoan tk = DAO.daoTaiKhoan.getInstance().getTaiKhoan(this.maNV);
        NhanVien nv=null;
        if(tk!=null)
            nv =DAO.daoTaiKhoan.getInstance().getNhanVien(tk.getMaNV());
        String tennv =null;
        if(nv==null) tennv="";
        else tennv = nv.getTenNV();
    ...
    DAO.daoXuatKho.getInstance().KiemTraXuatKho(id_lo, soluongton, soluong, thoigian, maNV);
