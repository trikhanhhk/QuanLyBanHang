...
public class fDanhSach_NhapHang extends javax.swing.JFrame {
    ...
    public fDanhSach_NhapHang(String maNV) {
        initComponents();
        setIcon();
        this.maNV = maNV;
    ...
    private void jButtonTaoMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTaoMoiActionPerformed
        JFrame ChonSanPham = new fChonSanPham_NhapHang(maNV);
    ...
    private void jButtonSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSuaActionPerformed
        ...
        JFrame Xem = new fCreateKhuVuc(maNV, true, id);
        Xem.setVisible(true);
        // TODO add your handling code here:
...
//        JFrame ThongBao = new fThongBaoHuy("PhieuNhap", id, maNV);
//        ThongBao.setVisible(true);
    ...
    public void NhanVienDangNhap() {
        if (maNV != 0) {
            ...
            NhanVien nv = DAO.daoTaiKhoan.getInstance().getNhanVien(tk.maNV);
