...
public class fCreateTraHang extends javax.swing.JFrame {
    ...
    public fCreateTraHang(String maNV,int id_kho) {
        this.maNV=maNV;
        this.id_kho=id_kho;
        initComponents();
        setIcon();
    ...
    public void ThongTin()
    {
        ...
        jTextFieldNhanVien.setText(nv.getTenNV());
    ...
    private void jButtonLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLuuActionPerformed
        ...
        if(DAO.daoTraNhaCungCap.getInstance().InsertPhieuTra(id_kho, maNV))
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fCreateTraHang("NV12",3).setVisible(true);
            }
        });
    }
