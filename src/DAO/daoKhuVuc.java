...
public class daoKhuVuc {
    ...
    public boolean HuyKhuVuc(int id, String id_nv)
    {
        ...
        try {
            ...
            DAO.daoThongBao.getInstance().insertThongBao("[Khu vực] Nhân viên " + DAO.daoTaiKhoan.getInstance().getNhanVien(id_nv).getTenNV() + " đã xóa khu vực vào lúc " + DAO.DateTimeNow.getIntance().Now, DAO.DateTimeNow.getIntance().Now, 6);
        } catch (Exception e) {
